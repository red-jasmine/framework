                ...
                Section::make(__('red-jasmine-product::product-price.labels.basic_info'))
                    ...
                    ->schema([
                        ...
                        TextInput::make('priority')
                            ...
                            ->numeric()
                            ->default(0)
                            ->helperText(__('red-jasmine-product::product-price.helpers.priority')),
                    ]),

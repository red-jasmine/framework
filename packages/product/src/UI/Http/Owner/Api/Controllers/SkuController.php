...
use RedJasmine\Product\UI\Http\Owner\Api\Resources\StockLogResource;
use RedJasmine\Product\UI\Http\Owner\Api\Resources\StockSkuResource;
...
class SkuController extends Controller
{
    public function __construct(
        ...
        $this->queryService->repository->withQuery(function ($query) {
            $query->onlyOwner($this->getOwner());
        });


        $this->logQueryService->repository->withQuery(function ($query) {
            $query->onlyOwner($this->getOwner());
        });

...
class AdminReadRepository extends UserReadRepository implements AdminReadRepositoryInterface
{
    ...
    {
        return parent::findByEmail($email); // TODO: Change the autogenerated stub
    }

    public function findByPhone(string $phone) : ?Admin
    {
        return parent::findByPhone($phone); // TODO: Change the autogenerated stub
    }

    public function findByAccount(string $account) : ?Admin
    {
        return parent::findByAccount($account); // TODO: Change the autogenerated stub
    }

    public function findByConditions($credentials) : ?Admin
    {
        return parent::findByConditions($credentials); // TODO: Change the autogenerated stub
    }

        ...
        Route::prefix('coupon')
             ->group(function () {
                 ...
                 Route::prefix('user-coupons')->group(function () {
                     ...
                     // 统计信息
                     Route::get('/statistics/overview', [UserCouponController::class, 'statistics'])->name('shop.api.user-coupons.statistics');
                 });
                 ...
                 Route::prefix('usage-records')->group(function () {
                     ...
                     // 统计信息
                     Route::get('/statistics/overview', [CouponUsageController::class, 'statistics'])->name('shop.api.coupon-usage.statistics');
                 });

...
class OrderRefundResource extends JsonResource
{
    public function toArray(Request $request) : array
    {
        return [
            ...
            'images'                 => $this->extension->images,
            'outer_refund_id'        => $this->outer_refund_id,
            'refund_status'          => $this->refund_status,
            'refund_amount'          => $this->refund_amount,
            'reject_reason'          => $this->extension->reject_reason,
            'created_time'           => $this->created_time,
            'end_time'               => $this->end_time,
            'seller_custom_status'   => $this->seller_custom_status,
            'seller_remarks'         => $this->extension->seller_remarks,
            'buyer_remarks'          => $this->extension->buyer_remarks,

 ...
 * @method static \RedJasmine\Promotion\Domain\Models\ActivityOrder handleParticipation(\RedJasmine\Promotion\Domain\Models\Activity $activity, \RedJasmine\Support\Domain\Contracts\UserInterface $user, array $participationData)
 ...
 * @method static bool canParticipate(\RedJasmine\Promotion\Domain\Models\Activity $activity, \RedJasmine\Support\Domain\Contracts\UserInterface $user, array $participationData = [])
 * @method static string|null getParticipationFailureReason(\RedJasmine\Promotion\Domain\Models\Activity $activity, \RedJasmine\Support\Domain\Contracts\UserInterface $user, array $participationData = [])

...
//    }
    ...
    protected static function boot() : void
    {
        ...
        static::saving(callback: function (Product $product) {
        ...
        static::deleting(callback: function (Product $product) {
            $product->info()->delete();
            $product->skus()->delete();
            // 只有在 物理删除时才进行删除

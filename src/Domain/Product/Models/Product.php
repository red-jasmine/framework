...
class Product extends Model implements OperatorInterface, OwnerInterface
{
    ...
    public function sellerExtendCategories() : BelongsToMany
    {
        return $this->belongsToMany(ProductSellerCategory::class,
                                    config('red-jasmine-product.tables.prefix') . 'product_seller_extend_category_pivots',
                                    'product_id',
                                    'seller_category_id')
                    ->using(ProductSellerExtendCategoryPivot::class)
                    ->withTimestamps();

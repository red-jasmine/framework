...
CREATE TABLE project_members (
    ...
    invited_by_type VARCHAR(255) NULL, -- 邀请人多态关联类型
    invited_by_id BIGINT UNSIGNED NULL, -- 邀请人多态关联ID
...
class ProjectMember extends Model
{
    ...
    protected $fillable = [
        'project_id', 'member_type', 'member_id', 'role_id', 'status',
        'joined_at', 'left_at', 'invited_by_type', 'invited_by_id', 'permissions'
    ];

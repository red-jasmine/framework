...
CREATE TABLE `promotion_activities` (
  ...
  `creator_type` varchar(64) NOT NULL COMMENT '发起方类型 (platform, merchant)',
  `creator_id` varchar(64) NOT NULL COMMENT '发起方ID',
  `creator_name` varchar(255) COMMENT '发起方名称',
...
CREATE TABLE `promotion_activity_products` (
  ...
  `sales_volume` int DEFAULT 0 COMMENT '商品销量',

...
1. **优惠券**：优惠券的核心实体，包含基本信息、类型、成本承担方、配置信息等（已合并配置信息）
2. **发放策略**：定义优惠券的发放规则，包括发放方式、数量限制等
3. **使用限制**：定义优惠券的使用约束，包括用户限制、商品限制等
4. **用户优惠券**：用户领取的优惠券实例，包含使用状态、过期时间等
5. **优惠券使用记录**：记录优惠券的使用详情，包括使用金额、优惠金额等
6. **优惠券统计**：存储优惠券的统计数据，包括发放数量、使用率等
